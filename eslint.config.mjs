...
const PALETTE_UTILITY =
  "\\b(?!bg-white\\b)(bg|text|border|ring|fill|stroke|from|via|to)-(black|white|slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)(-\\d{1,3})?\\b";
const TYPE_UTILITY =

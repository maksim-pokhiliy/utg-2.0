...
| U5a | Contacts + copy + editable summary; payload flips to the v2 envelope (`delivery.mode: "generic"`, both locales)                 | `/step`                                      | +380 normalization units; v2 contract test; summary-editing e2e; a real order renders in the bot | pending |

...
(function () {
  function Drawer(props) {
    ...
    var lines = items.map(function (it) {
      return h("div", { className: "utg-cartline", key: it.id, style: { alignItems: "stretch" } },
        h("img", { src: it.image, alt: "", style: { alignSelf: "stretch", width: "64px", height: "auto", minHeight: "64px", objectFit: "cover" } }),
        h("div", { style: { display: "flex", flexDirection: "column", justifyContent: "space-between", gap: "8px", minHeight: "64px", minWidth: 0 } },
